...
<div class="container w-50 ">
  ...
  <form method="POST" action="handle/store.php" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="title" value="<?php if(isset($_SESSION['title']))?>" name="title">
    </div>
    <div class="mb-3">
        <label for="body" class="form-label">Body</label>
        <textarea class="form-control" id="body" name="body" rows="5" value="<?php if(isset($_SESSION['body'])) echo $_SESSION['body'] ?>"></textarea>
    </div>
    <div class="mb-3">
